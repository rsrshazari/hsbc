...
if($delQry){
header("location:viewpage.php?msg=dls&pid=$pid");
}else{
header("location:viewpage.php?msg=dlf&pid=$pid");
}
}
...
break;
case 'dls':
$msg= $name.'Page Deleted Successfully !!';
$class='success';
break;
case 'default' :
$msg='';
...
<td width="20%" style="vertical-align:middle!important;">
<a href="viewcontent.php?pid=<?php echo base64_encode($page['id']) ?>"><button type="button" class="btn btn-light " title="Edit Page Content" ><i class="fas fa-edit"></i> </button></a>
<a href="viewpage.php?did=<?php echo base64_encode($page['id']) ?>">
	<button type="button" class="btn btn-light " title="Delete Page Content" onClick="errorMsg()";><i class="fas fa-trash-alt"></i> </button></a>
</td>
</tr>
</table>
</div>
